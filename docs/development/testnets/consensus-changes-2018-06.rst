...
From Abstract of `BSIP-38 <https://github.com/localcoin/bsips/blob/master/bsip-0038.md>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
This BSIP depends on `BSIP 31 <https://github.com/localcoin/bsips/blob/master/bsip-0031.md>`_ .

Discussion and Development
---------------------------------------------

* `Development Overview <https://github.com/localcoin/localcoin-core/issues/834>`_

* `Technical Discussion <https://github.com/localcoin/localcoin-core/pull/838>`_

* `Summary of Code Changes (Merge) <https://github.com/localcoin/localcoin-core/pull/838/files/610dbf519aa2a97523a6d753df93a00f368e4f8e>`_

* `Summary of Code Changes (Pull Request) <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f>`_

* `Individual Code Changes <https://github.com/localcoin/localcoin-core/pull/838/commits>`_


Unit Tests
---------------------------------------------

* `Changes to the test framework that imitates a live blockchain (Implementation) <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f#diff-472805f6e072745a1efe846e5a8d44f7>`_
...
* `Changes to test framework that imitates a live blockchain (Header) <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f#diff-39d175fc7ddf571106cb34222239fb3b>`_
...
* `Test the ability to create call orders with different target collateral ratios even without submitting them to the blockchain <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f#diff-0f99622d84284fc682365f4b325b624e>`_
...
* `Test of rounding of the multiplication of prices and quantities <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f#diff-5984197c09fc34872620ff6206e29e35>`_
...
* `Test of call orders <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f#diff-6f4426832d588f71164d10b4407f2137>`_
...
* `Test of market orders <https://github.com/localcoin/localcoin-core/commit/14c9786ba9946599a6e13ccdb9928d9d152f2a7f#diff-5c2422e9af6788cd1cc3e76296e1c7c4>`_
