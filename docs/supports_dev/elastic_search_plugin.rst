...
The document explains motivations, technical challenges and sample use of a new plug-in created for localcoin to store account history data into an elasticsearch database.
...
- The number of github issues in regards to new api calls to lookup account history in different ways. ``elasticsearch-plugin`` will allow users to search account history querying directly into the database without the localcoin-core team creating and maintaining API calls for every case.

Additionally we are after a secure way to store error free full account data. The huge amount of operations data involved in localcoin blockchain and the way it is serialized makes this a big challenge.
...
It is very recommended that you use SSD disks in your node if you are trying to synchronize localcoin blockchain. It will make the task a lot faster.
...
:elasticsearch-index-prefix:   A prefix for your indexes - default: "localcoin-"
...
If you only have command line available you can query the database directly throw curl as:::
	...
	root@NC-PH-1346-07:~/localcoin/elastic/localcoin-core# curl -X GET 'http://localhost:9200/localcoin-*/data/_count?pretty=true' -H 'Content-Type: application/json' -d '
	{
		"query" : {
			"bool" : { "must" : [{"match_all": {}}] }
		}
	...
	root@NC-PH-1346-07:~/localcoin/elastic/localcoin-core# 
...
A synchronized node will look like this(screen capture 02/08/2018)::
	...
	root@NC-PH-1346-07:~# curl -X GET 'http://localhost:9200/localcoin-*/data/_count?pretty=true' -H 'Content-Type: application/json' -d '
	{
		"query" : {
			"bool" : { "must" : [{"match_all": {}}] }
		}
...
List your indexes as::
	...
	yellow open localcoin-2018-02 voS1uchzSxqxqkiaKNrEYg 5 1  18984984 0  10.8gb  10.8gb
	yellow open localcoin-2018-06 D6wyX58lRyG3QOflmPwJZw 5 1  28514130 0  15.6gb  15.6gb
	yellow open localcoin-2017-10 73xRTA-fSTm479H4kOENuw 5 1   9326346 0   5.2gb   5.2gb
	yellow open localcoin-2016-08 -MMp3VGGRZqG2YL1LQunbg 5 1    551835 0 270.1mb 270.1mb
	yellow open localcoin-2016-07 Ao56gO9LQ-asMhX50rbcCg 5 1    609087 0 303.2mb 303.2mb
	yellow open localcoin-2018-05 9xuof-PiRQWburpW8ZXHVg 5 1  29665610 0  17.3gb  17.3gb
	yellow open localcoin-2017-01 SpfwEzGcSoy9Hd6c6fzv2g 5 1   1197124 0   659mb   659mb
	yellow open localcoin-2017-12 tF5af4OvTLqcx3IYUJSQig 5 1  13244366 0   7.5gb   7.5gb
	yellow open localcoin-2016-03 yy91IvyATOCEoFHjgDbalg 5 1    597461 0 297.4mb 297.4mb
	yellow open localcoin-2015-12 z-ZAZqHsQL2EDNpf3_ghGA 5 1    349985 0 151.3mb 151.3mb
	yellow open localcoin-2017-07 OOr_xW4STsCm3sev1xtTRQ 5 1  17890903 0   9.6gb   9.6gb
	yellow open localcoin-2016-04 jt9q50ADQuylV4l25zGAaw 5 1    413798 0 205.6mb 205.6mb
	yellow open localcoin-2016-11 mWz7DpjSQyqJ_rL8gtMqWw 5 1    495556 0   260mb   260mb
	yellow open localcoin-2016-12 2qht_wrXTUmNqDvczpHYzw 5 1    917034 0 506.6mb 506.6mb
	yellow open localcoin-2016-10 vAMb0kW6Stqz6CNbuu7PEQ 5 1    416570 0 208.8mb 208.8mb
	yellow open localcoin-2015-11 ETNFuF3sTPe-gTSzX3bdIg 5 1    301079 0 131.9mb 131.9mb
	yellow open localcoin-2017-08 73Q2Asw-Rf228oQLoSCLGw 5 1   9916248 0   5.6gb   5.6gb
	yellow open localcoin-2016-05 3c95AvKcQk2puBwVt_HIqQ 5 1    498493 0   246mb   246mb
	yellow open localcoin-2017-02 lsiiz7PmS2q9_P2BQpNkNQ 5 1   1104282 0 586.7mb 586.7mb
	yellow open localcoin-2017-11 4pqwIRdWSwSe5198YNz-Nw 5 1  14107174 0     8gb     8gb
	yellow open localcoin-2018-07 fdmfXLqSTESODyLI_7cjXg 5 1 133879948 0  51.3gb  51.3gb
	yellow open localcoin-2016-06 Is11IdcnT8mfBPpoLUjJyw 5 1    656358 0 330.3mb 330.3mb
	yellow open localcoin-2018-04 MEA8fCsgSbOVXa0Z05cfsA 5 1  20940461 0  11.9gb  11.9gb
	yellow open localcoin-2018-03 fMjxhFwHSP-6ewrl0Ns6ZQ 5 1  20335546 0    12gb    12gb
	yellow open localcoin-2017-09 o-b2Bf3LR0-J1kUiv4FpHA 5 1  11075939 0   6.3gb   6.3gb
	yellow open localcoin-2018-01 jw9rYlmTSvuLC1hHcYyU4Q 5 1  19396703 0  11.2gb  11.2gb
	yellow open localcoin-2018-08 EDRxQvxhQJe3Vam_FxZMWg 5 1   8038498 0     3gb     3gb
	yellow open localcoin-2016-09 fo2AL0y7T_q_HtXEYCv35Q 5 1    409164 0 203.4mb 203.4mb
	yellow open localcoin-2016-01 3sjjs-4oQMm5HG-vUTuyoA 5 1    372772 0 168.7mb 168.7mb
	yellow open localcoin-2017-03 ZxjWksRyTaGstm6T2Kxl9A 5 1   2167788 0   1.1gb   1.1gb
	yellow open localcoin-2016-02 toWbFwI-RB2wEGrR8873rQ 5 1    468174 0 222.7mb 222.7mb
	yellow open localcoin-2017-05 IEZQ-rtmQU2kKNcRb58Egg 5 1  10278394 0   5.6gb   5.6gb
	yellow open localcoin-2017-04 S1h2eBGiS3quNJU7CqPR7Q 5 1   3316120 0   1.8gb   1.8gb
	yellow open localcoin-2017-06 0HYkECRbSwGDrmDFof8nqA 5 1  10795239 0     6gb     6gb
	yellow open localcoin-2015-10 XyKOlrTWSK6vQgdXm8SAtQ 5 1    161004 0  84.5mb  84.5mb
	root@NC-PH-1346-07:~# 

If you don't see any index here then something is wrong with the localcoin-core node setup with elasticsearch plugin.

Pre-Define Settings
=========================

By default data indexes will be created with default elasticsearch settings. Node owner can tweak the default settings for all the ``localcoin-*`` indexes before the addition of any data.
...
This is one of the issues that has been requested constantly. It can be easily queried with ES plugin by calling the _search endpoint doing:::
	...
	curl -X GET 'http://localhost:9200/localcoin-*/data/_search?pretty=true' -H 'Content-Type: application/json' -d '
	{
		"query" : {
...
https://github.com/oxarbitrage/localcoin-es-wrapper
