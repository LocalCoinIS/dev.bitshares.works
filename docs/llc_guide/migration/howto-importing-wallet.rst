...
The web wallet of LocalCoin has a **Wallet management Console.** that will
help you import your funds. It can be access via `LocalCoin: Settings -> Wallets` 

.. image:: wallet-management-console.png
        :alt: Wallet Management Console in LocalCoin
        :width: 550px
        :align: center
...
.. image:: wallet-management-console-import-keys.png
        :alt: Wallet Management Console in LocalCoin -- Import Keys
        :width: 550px
        :align: center

|

Here you can provide the wallet backup file produced from LocalCoin 0.9.3c and
...
.. image:: import-keys.png
        :alt: Import Wallet Backup from LocalCoin 1.0
        :width: 550px
        :align: center
