...
How is accounting addressed in Localcoin? Is it a Nxt style accounting model or like Bitcoin's UTXO
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Is there a specification for Localcoin scripting language? (assuming there is one)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Current 2 seconds, configurable by chain parameters.


.. _dev-faq14:

What is the average size in Bytes of a Localcoin transaction?
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
What is the standard Localcoin address structure and format?
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
