...
If you want to register the account of someone else, all you need is the public key. In theory, the LocalCoin blockchain distinguishes three keys for each account, namely the **owner**, **active**, and the **memo** key. However, for the sake of simplicity, we here make use of only one public key.
