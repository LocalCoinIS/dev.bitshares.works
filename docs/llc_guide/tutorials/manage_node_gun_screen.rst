...
When I started working in the localcoin-core one of the first problems I found after building a node was a proper way to run a node in the background.
...
More cool stuff can be done with screen but these are the basics for using it with localcoin nodes.
...
If you have several screens going on, the ``screen -r`` will not work for you, but follow the command suggestions and you will know how to gain control of each terminal again::
    ...
    root@alfredo:~/localcoin-munich/recurring/localcoin-core# screen -r
    There are several suitable screens on:
            11873.pts-2.alfredo     (09/01/17 20:07:00)     (Detached)
            11831.pts-2.alfredo     (09/01/17 19:55:18)     (Detached)
    Type "screen [-d] -r [pid.]tty.host" to resume one of them.
    root@alfredo:~/localcoin-munich/recurring/localcoin-core# 
